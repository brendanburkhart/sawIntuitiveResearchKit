...
void mtsNeuralForceEstimation::InitializeState()
{
...
vct3 mtsNeuralForceEstimation::infer_jf(const vctDynamicVector<double>& jp, const vctDynamicVector<double>& jv)
{
    ...
    try {
        ...
        vct3 output_vec;
        for (size_t i = 0; i < output_shapes[0].size(); i++) {
